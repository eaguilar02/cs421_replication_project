...
This repository contains a partial replication of the ProxyLM methodology for predicting machine translation model performance using meta-learning. I implement the paper's feature extraction framework with 19 features and train XGBoost regressors on 24 meta-training examples across 6 language pairs.
...
I could not replicate exactly due to:
...
This partial replication validates the methodology at smaller scale, which is standard practice.
